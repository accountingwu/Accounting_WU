...
{
    public class ExchController : Controller
    {
        // GET: Expn //รหัสรายได้
        ...
        public ActionResult ManageExch(int? page)
        {
            ...
            var Exch = (from c in _db.MDExpn where c.ExpnType =="2"
            ...
            ViewBag.MyData = Exch.ToPagedList(pageNumber, pageSize);
            return View();
        }
