...
namespace AccountingSystemProject.DAL
{
    ...
    public partial class McM
    {
        ...
        public Nullable<decimal> numrfg { get; set; }
        public Nullable<int> statusMCType { get; set; }
        public Nullable<int> timeMTBF { get; set; }
        public string remarkBF { get; set; }
    }
}
