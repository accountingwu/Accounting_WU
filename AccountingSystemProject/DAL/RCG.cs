...
namespace AccountingSystemProject.DAL
{
    ...
    public partial class RCG
    {
        public int rcg_id { get; set; }
        ...
        public Nullable<System.DateTime> rcg_date { get; set; }
        public string wcode { get; set; }
        public string cuscode { get; set; }
        public string comment { get; set; }
        public Nullable<int> RCGstate { get; set; }
        public string statusRCG { get; set; }
