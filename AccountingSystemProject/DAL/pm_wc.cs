...
namespace AccountingSystemProject.DAL
{
    ...
    public partial class pm_wc
    {
        ...
        public Nullable<int> emp_wc { get; set; }
        public string emp_wc_name { get; set; }
        ...
        public Nullable<System.DateTime> start_dateWO { get; set; }
        public Nullable<System.DateTime> finish_dateWC { get; set; }
        public Nullable<int> duration_time { get; set; }
        public Nullable<decimal> sum_maerial_cost { get; set; }
        public Nullable<decimal> sum_labor_cost { get; set; }
        public Nullable<decimal> sum_other_cost { get; set; }
